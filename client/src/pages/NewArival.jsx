...
import { getNewArival } from '../features/product/productSlice';
        ...
        <main className='flex-grow container mx-auto px-4 py-12 md:py-16 bg-gray-50 text-gray-800'>
            ...
            <div className='text-center mb-12 md:mb-16'>
                ...
                <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
                    Be the first to discover our latest collection of fresh styles and must-have essentials.
                </p>
            </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8'>
                    {products && products.length > 0 ? (
                        ...
                        <div className='col-span-full text-center py-20 bg-white rounded-xl shadow-lg border border-gray-200'>
                            <p className='text-2xl font-semibold text-gray-500'>No new arrivals at the moment.</p>
                        </div>
                    )}
                </div>
            )}
